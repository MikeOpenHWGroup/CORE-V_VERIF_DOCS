...
+-----------+------------------------------------------------------+
| $PROJ\_ROOT | Local path of a cloned copy of a GitHub repository. An example to illustrate: <br>[prompt]$** cd /wrk/greg/openhw <br>[prompt]$** git clone https://github.com/openhwgroup/core-v-verif<br>Here $PROJ\_ROOT is /wrk/greg/openhw/core-v-verif. Note that this is not a required shell variable – its use in this document is merely as a reference point for an absolute path to your working copy. |
+-----------+------------------------------------------------------+
